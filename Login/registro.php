        ...
        <div class="row">
            <fieldset class="col-xs-10 col-xs-offset-1">
                ...
                <form method="POST" action="registrar.php">
                    	...
                    	<input type="password" name="npassword" class="form-control col-xs-12 Input" placeholder="Contraseña">
                        <input type="password" name="npassword2" class="form-control col-xs-12 Input" placeholder="Confirmar contraseña">
